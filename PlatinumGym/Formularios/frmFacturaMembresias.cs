...
{
    public partial class frmFacturaMembresias : Form
    {
        public frmFacturaMembresias()
        {
            InitializeComponent();
        }
        ...
        //    if (txtIdeArti.Text != "")
        //    {
        //        dtgDetalle.Rows.Add("", lblNroFact.Text, txtIdeArti.Text, txtNombreArticulo.Text, txtCantidad.Text, txtPVP.Text, txtValor.Text, txtIdeMembresia.Text, txtNombreMembresia.Text, txtInicioMembresia.Text, txtFinalMembresia.Text, txtCosto.Text);
        //        txtIdeArti.Clear();
        ...
        private void btnAgregarMembresia_Click(object sender, EventArgs e)
        {
            ...
            if (fr.Pasar == true)
            {
                ...
                txtInicioMembresia.Text = fr.dtgvMembresias.CurrentRow.Cells["IniciMembr"].Value.ToString();
